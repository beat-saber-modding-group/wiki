...
| **Face Puncher** | [Block](#b) placement that consists of one or two diagonal up blocks crossed over into the extreme opposite [Lane](#l). Many players will overswing trying to reach the blocks and end up punching their HMD. Also known as [Vibe Check](#uv). <details><summary>**Example Image**</summary>![Picture of face puncher](~@images/mapping/facepuncher.png)</details> |
...
| **Flower** | A combination of two or more [Notes](#n) that are different directions, creating a flower like shape. 
...
| **Vibe Check** | [Block](#b) placement that consists of one or two diagonal up blocks crossed over into the extreme opposite [Lane](#l). Many players will overswing trying to reach the blocks and end up punching their HMD. Also known as [Face Puncher](#f). <details><summary>**Example Image**</summary>![Picture of vibe check](~@images/mapping/facepuncher.png)</details> |
